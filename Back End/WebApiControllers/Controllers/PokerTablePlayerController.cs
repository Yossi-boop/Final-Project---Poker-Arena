    ...
    public class PokerTablePlayerController : ApiController
    {
        ...
        public IHttpActionResult Get(string CasinoId, string TableId)
        {
                ...
                catch (Exception e)
                {
                    ...
                    {
                        file.WriteLine("PokerTablePlayerController.get1/" + e.Message);
                    }
                    return BadRequest("");
                }
        ...
        public IHttpActionResult Get(string CasinoId, string TableId, string email)
        {
                ...
                catch (Exception e)
                {
                    using (System.IO.StreamWriter file = new System.IO.StreamWriter(Logger.Path, true))
                    {
                        file.WriteLine("PokerTablePlayerController.get2/" + e.Message);
                    }
                    return BadRequest("");
        ...
        public void Get(string CasinoId, string TableId, string Email, string Signature)
        {
                ...
                catch (Exception e)
                {
                    using (System.IO.StreamWriter file = new System.IO.StreamWriter(Logger.Path, true))
                    {
                        file.WriteLine("PokerTablePlayerController.get3/" + e.Message);
                    }
                }
        ...
        public IHttpActionResult Post([FromBody]UserToAddToPokerTable i_User)
        {
                ...
                catch (Exception e)
                {
                    using (System.IO.StreamWriter file = new System.IO.StreamWriter(Logger.Path, true))
                    {
                        file.WriteLine("PokerTablePlayerController.post/" + e.Message);
                    }
                    return BadRequest("");
                }
        ...
        public void Put([FromBody]PokerPlayerReBuyDetails i_Details)
        {
                ...
                catch (Exception e)
                {
                    using (System.IO.StreamWriter file = new System.IO.StreamWriter(Logger.Path, true))
                    {
                        file.WriteLine("PokerTablePlayerController.put/" + e.Message);
                    }
                }
        ...
        public void Delete(string CasinoId, string TableId, string Email, string Signature)
        {
                ...
                catch (Exception e)
                {
                    using (System.IO.StreamWriter file = new System.IO.StreamWriter(Logger.Path, true))
                    {
                        file.WriteLine("PokerTablePlayerController.delete/" + e.Message);
                    }
                }
